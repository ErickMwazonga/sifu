...
### Easy 
1. [704. Binary Search](./binary_search.py)
2. [367. Valid Perfect Square](./sqrt/valid_perfect_square.py)
3. [441. Arranging Coins](./arranging_coins.py)
4. [374. Guess Number Higher or Lower](./guess_number_lower_higher.py)
5. [278. First Bad Version](./first_bad_version.py)

### Medium
1. [153 Find the Minimum Element in a Sorted and Rotated Array](./min_sorted_rotated.py)
2. [33. Search in Rotated Sorted Array](./search_rotated_sorted.py)
...
2. [153. Find the Minimum Element in a Sorted and Rotated Array](./min_sorted_rotated.py)
