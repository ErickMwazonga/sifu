...
class BikeRental:
    ...
    def rentBikeOnHourlyBasis(self, n):
        ...
        if n <= 0:
            ...
            print(
                f"Sorry! We have currently {self.stock} bikes available to rent."
            )
            return None
        else:
            now = datetime.datetime.now()
            print(
                f"You have rented a {n} bike(s) on hourly basis today at {now.hour} hours."
            )
    ...
    def rentBikeOnWeeklyBasis(self, n):
        ...
        if n <= 0:
            ...
            now = datetime.datetime.now()
            print(
                f"You have rented a {n} bike(s) on weekly basis today at {now.hour} hours."
            )
